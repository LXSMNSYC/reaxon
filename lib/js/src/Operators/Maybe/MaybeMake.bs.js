...
function operator(onSubscribe) {
  return /* record */[/* subscribeWith */(function (obs) {
              ...
              var $$protected = ProtectedMaybeObserver$Reaxon.make(obs);
              ...
              var emitter_003 = function (x) {
                if (alive[0]) {
                  Curry._1($$protected[/* onSuccess */2], x);
                  return Curry._1(subscription[/* cancel */0], /* () */0);
                } else {
                  return 0;
                }
              ...
              var emitter_004 = function (x) {
                if (alive[0]) {
                  Curry._1($$protected[/* onError */3], x);
                  return Curry._1(subscription[/* cancel */0], /* () */0);
                } else {
                  throw x;
                }
              ...
              try {
                ...
                return Curry._1(emitter_004, Caml_js_exceptions.internalToOCamlException(raw_e));
              }
            })];
}
