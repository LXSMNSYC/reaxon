              ...
              if (cached[0]) {
                ...
                if (match !== undefined) {
                  ...
                  if (typeof item === "number") {
                    ...
                    return Curry._1(safe[/* onError */3], item[0]);
                  } else {
                    return Curry._1(safe[/* onSuccess */2], item[0]);
                  }
                } else {
                  return /* () */0;
                }
                  ...
                  return Curry._1(source[/* subscribeWith */0], SafeMaybeObserver$Reaxon.make(/* record */[
                                  ...
                                  /* onSuccess */(function (x) {
                                      if (cached[0]) {
                                        ...
                                        cached[0] = true;
                                        signal[0] = /* OnSuccess */Block.__(0, [x]);
                                        List.iter((function (observer) {
                                                return Curry._1(observer[/* onSuccess */2], x);
                                              }), observers[0]);
                                        return OptionalSubscription$Reaxon.cancel(subRef[0]);
                                      }
                                    }),
                                  /* onError */(function (x) {
                                      if (cached[0]) {
                                        ...
                                        cached[0] = true;
                                        signal[0] = /* OnError */Block.__(1, [x]);
                                        List.iter((function (observer) {
                                                return Curry._1(observer[/* onError */3], x);
                                              }), observers[0]);
                                        return OptionalSubscription$Reaxon.cancel(subRef[0]);
                                      }
                                    })
