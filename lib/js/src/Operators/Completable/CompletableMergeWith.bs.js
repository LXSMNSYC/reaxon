...
function operator(other, source) {
  return /* record */[/* subscribeWith */(function (obs) {
              ...
              Curry._1(source[/* subscribeWith */0], SafeCompletableObserver$Reaxon.make(/* record */[
              ...
              return Curry._1(other[/* subscribeWith */0], SafeCompletableObserver$Reaxon.make(/* record */[
                              /* onSubscribe */(function (sub) {
                                  return Curry._1(composite[/* add */3], sub);
                                }),
                              /* onComplete */(function (param) {
